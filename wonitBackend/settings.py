"""
Django settings for wonitBackend project.
...
SECRET_KEY = 'django-insecure-vt)-f%85s-x01-6eq^&$q2b3ahs@t8jy)jf4+k0fii0f3sh9)!'
...
WSGI_APPLICATION = 'wonitBackend.wsgi.application'
